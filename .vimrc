...
" Set default printer:      lpoptions -d <printer name>
" <silent> means do not display output.
nnoremap <silent> <leader>p :%w !p<CR>

" Type jj to exit insert mode quickkly.
inoremap jj <Esc>
...
" Exit insert ode after creating a new line above or below the current line.
nnoremap o o<esc>
nnoremap O O<esc>
